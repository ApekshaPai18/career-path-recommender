...
const Form = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    localStorage.setItem("careerForm", JSON.stringify({ education, skills, interest }));
  ...
  return (
    <>
      <Navbar />
      <div className="w-full min-h-screen bg-gradient-to-bl from-sky-200 to-sky-900 flex justify-center items-center px-4 py-10">
        <form
          onSubmit={handleSubmit}
          className="bg-white w-full sm:max-w-md md:max-w-lg lg:max-w-xl p-6 sm:p-8 rounded-xl shadow-xl space-y-6"
        >
          <h2 className="text-xl sm:text-2xl font-bold text-slate-800 text-center">Tell Us About Yourself</h2>
